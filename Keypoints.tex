...
両者の相違点および具体例を表\ref{difference}に示す．
\begin{table}[H]
	\centering
	\caption{ネットワークの形態間の相違点および具体例} \label{difference}
	\begin{tabular}{|l||l|l|} 
		\cline{2-3}
		\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{\textbf{経路切替え型ネットワーク}}&\multicolumn{1}{c|}{\textbf{媒体共有型ネットワーク}}\\\hline
		ネットワーク&固定&固定しない\\\hline
